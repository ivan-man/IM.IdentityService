...
namespace IM.IdentityService.DataAccess.Migrations
{
    ...
    [Migration("20220819154547_applicationKeyUnique")]
    partial class applicationKeyUnique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IM.IdentityService.Domain.Models.ApplicationUsing", b =>
                {
                    ...
                    b.HasKey("ApplicationUserId", "ApplicationId");

                    b.HasIndex("ApplicationId");

                    b.HasIndex("ApplicationUserId");

                    b.ToTable("ApplicationUsings", "public");
                });
            ...
            modelBuilder.Entity("IM.IdentityService.Domain.Models.ApplicationUsing", b =>
                {
                    b.HasOne("IM.IdentityService.Domain.Models.Application", "Application")
                        .WithMany("ApplicationUsings")
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IM.IdentityService.Domain.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("ApplicationUsings")
            ...
            modelBuilder.Entity("IM.IdentityService.Domain.Models.Application", b =>
                {
                    b.Navigation("ApplicationUsings");
                });
